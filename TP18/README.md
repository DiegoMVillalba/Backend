...
Por ejemplo, el día 1 de Diciembre del 2022 corrí los tests, se generó **`TestResults_2022-12-1.txt`** en la carpeta `testresults`

```console
cat testresults/TestResults_2022-12-1.txt
